...
export default function OrganicKpiRow({ ga4, compareLabel }: Props) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
      ...
      {ga4.organicTransactions > 0 && (
        <KpiCard
          ...
          tooltip={`Organic search transactions ${compareLabel} (GA4)`}
        />
      )}
    </div>
  )
